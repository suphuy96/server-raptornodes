...
`,d=r.Ps`
   query withdrawlWeeklyInfo($author:String,$createdAt:InputSearchDate){
    withdrawlWeeklyInfo(author:$author,createdAt:$createdAt) {
      balance
      received
      address
      weeklyFund
...
`,c=r.Ps`
  query withdrawlWeeklyInfoUser ($createdAt:InputSearchDate){
    withdrawlWeeklyInfoUser(createdAt:$createdAt){
      withdrawlIsPending
      withdrawlISPaid
      withdrawlISPaidCount
      withdrawlIsPendingCount
